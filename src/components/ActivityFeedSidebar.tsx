...
export const ActivityFeedSidebar: React.FC<NotesFeedSidebarProps> = ({
  visible,
  onHide,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* Bolt icon */}
            <img src={boltIcon} alt="Activity" style={{ width: '24px', height: '24px' }} />
            <div style={{
              color: '#0F172A',
              fontSize: '16px',
              fontFamily: 'Inter',
                ...
                <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          {note.author}
                          {note.id === '1' && (
                            <span style={{ fontWeight: 400, color: '#111827' }}> took <span style={{ fontWeight: 600, color: '#111827' }}>Vernon & Foster, LLP</span> on <span style={{ fontWeight: 600, color: '#1D4ED8' }}>tour</span></span>
                          )}
                          {note.id === '2' && (
                            <span style={{ fontWeight: 400, color: '#111827' }}> created <span style={{ fontWeight: 600 }}>NYC Office</span> <span style={{ color: '#111827' }}>property</span> <span style={{ fontWeight: 600, color: '#1D4ED8' }}>survey</span></span>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  {note.id === '1' ? (
                    <div style={{
                       ...
                       <img src={typeIcon} alt="Location" style={{ width:'16px', height:'16px' }} />
                       <span style={{ fontSize:'14px', color:'#111827' }}>
                          <span>95 Park Ave, New York, NY 10117</span> <span style={{ color:'#6B7280' }}>Space 410</span>
                       </span>
                     </div>
                  ) : note.id === '2' ? (
                    <div style={{ display:'flex', alignItems:'center', gap:'4px', marginLeft:'4px' }}>
                      <img src={buildingIcon} alt="Building" style={{ width:'16px', height:'16px' }} />
                      <span style={{ fontSize:'14px', color:'#111827' }}>Crucial AI <span style={{ color:'#6B7280' }}>NYC HQ</span></span>
                    </div>
                  ) : null}
